...
public class ShowBalanceForm extends MyFormBuilder {
	final String myName="ShowBalanceForm";
	...
	ShowBalanceForm(){
		super();
		currentFormType=Form_Type.SHOW_BALANCE;
		nextFormType=Form_Type.SHOW_BALANCE;
		formName="SHOW_BALANCE";
	}
	@Override
	GridPane getGrid(Stage primaryStage){
        ...
        */
        ...
        dataHint1.setFont(Font.font("Tahoma", FontWeight.NORMAL, 10));
       ...
       // Scene scene = new Scene(grid, 300, 275);
        ...
        btn.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
            	...
            	processStatus=true;
            	//primaryStage.setScene(setProgressBarScene(primaryStage));
